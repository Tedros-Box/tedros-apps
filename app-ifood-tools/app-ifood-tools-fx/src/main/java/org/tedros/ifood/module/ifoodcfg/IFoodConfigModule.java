 ...
 * 
 */
package org.tedros.ifood.module.ifoodcfg;
...
import org.tedros.ifood.module.ifoodcfg.model.IFoodConfigMV;
...
@TView(items = { 
	@TItem(title = IFOODKey.MY_APP_MY_VIEW, 
			modelView=IFoodConfigMV.class, model=IFoodConfig.class)})
