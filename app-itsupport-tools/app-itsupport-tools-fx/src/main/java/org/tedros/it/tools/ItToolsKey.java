...
public interface ItToolsKey {
	...
	static final String GROUPS = "#{label.groups}";
	static final String HOUR = "#{label.hour}";
	static final String IMPORT = "#{label.import}";
	...
	static final String JSON_FILES = "#{label.json.files}";
	...
	static final String LABEL_MEETING_MINUTES = "#{label.meeting.minutes}";
	static final String MEETING_ACTIONS = "#{label.meeting.actions}";
	static final String MEETING_ACTIVITY_ID = "#{label.meeting.activity.id}";
	static final String MEETING_ADD_EVIDENCE = "#{label.meeting.add.evidence}";
	static final String MEETING_AGENDA = "#{label.meeting.agenda}";
	static final String MEETING_AI_DONE = "#{label.meeting.ai.done}";
	static final String MEETING_AI_PROCESSING = "#{label.meeting.ai.processing}";
	static final String MEETING_DATA = "#{label.meeting.data}";
	static final String MEETING_DATE = "#{label.meeting.date}";
	static final String MEETING_DEADLINE = "#{label.meeting.deadline}";
	static final String MEETING_FINISH_TIME = "#{label.meeting.finish.time}";
	static final String MEETING_GENERATE_FILE = "#{label.meeting.generate.file}";
	static final String MEETING_GENERATE_PDF_FIRST = "#{label.meeting.generate.pdf.first}";
	static final String MEETING_ISSUE_TITLE = "#{label.meeting.issue.title}";
	static final String MEETING_ITEM = "#{label.meeting.item}";
	static final String MEETING_NEXT = "#{label.meeting.next}";
	static final String MEETING_PARTICIPANTS = "#{label.meeting.participants}";
	static final String MEETING_PDF_OK = "#{label.meeting.pdf.ok}";
	static final String MEETING_PLACE = "#{label.meeting.place}";
	static final String MEETING_REDMINE = "#{label.meeting.redmine}";
	static final String MEETING_REDMINE_UPDATED = "#{label.meeting.redmine.updated}";
	static final String MEETING_REFERRALS = "#{label.meeting.referrals}";
	static final String MEETING_SEARCH_ISSUE = "#{label.meeting.search.issue}";
	static final String MEETING_SELECT_TRANSCRIPTION = "#{label.meeting.select.transcription}";
	static final String MEETING_SELECT_TRANSCRIPTION_FIRST = "#{label.meeting.select.transcription.first}";
	static final String MEETING_START_TIME = "#{label.meeting.start.time}";
	static final String MEETING_TOPIC = "#{label.meeting.topic}";
	static final String MEETING_TRANSCRIPTION = "#{label.meeting.transcription}";
	static final String MEETING_TRANSCRIPTION_NONE = "#{label.meeting.transcription.none}";
	static final String MEETING_UPDATE_ISSUE = "#{label.meeting.update.issue}";
	...
	static final String SELECT_JSON_FILE = "#{label.select.json.file}";
	...
	static final String VARIANTS = "#{label.variants}";
	...
	static final String VIEW_MEETING_MINUTES = "#{view.meeting.minutes}";
	static final String VIEW_MEETING_MINUTES_DESC = "#{view.meeting.minutes.desc}";
