...
public interface DomainApp {
	...
	static final String MEETING_MINUTES = "MEETING_MINUTES";
	...
	static final String MEETING_MINUTES_FORM_ID = MNEMONIC + SEP + MEETING_MINUTES + SEP + FORM;
	static final String MEETING_MINUTES_VIEW_ID = MNEMONIC + SEP + MEETING_MINUTES + SEP + VIEW;
