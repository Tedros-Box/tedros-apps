 ...
 * 
 */
package com.tedros.location;

/**
 * @author Davis Gordon
 *
 */
public interface LocatKey {

	static final String ADMIN_AREA_IMPORT_RULE_DESC = "#{admin.area.import.rule.desc}";
	static final String APP_LOCATION_NAME = "#{app.location.name}";
	static final String CITY_IMPORT_RULE_DESC = "#{city.import.rule.desc}";
	static final String COUNTRY_IMPORT_RULE_DESC = "#{country.import.rule.desc}";
	static final String FORM_KEEP_UPDATE = "#{form.keep.update}";
	static final String FORM_PLACE_TYPE = "#{form.place.type}";
	static final String FORM_REPO_PLACE = "#{form.repo.place}";
	static final String FORM_STREET = "#{form.street}";
	static final String HEADER_JASPER_PLACE = "#{header.jasper.place}";
	static final String HEADER_PLACE_TYPE = "#{header.place.type}";
	static final String HEADER_STREET = "#{header.street}";
	...
	static final String MENU_ADMIN_AREA = "#{menu.admin.area}";
	static final String MENU_ADMIN_AREA_POPOVER = "#{menu.admin.area.popover}";
	static final String MENU_CITY = "#{menu.city}";
	static final String MENU_CITY_POPOVER = "#{menu.city.popover}";
	static final String MENU_COUNTRY = "#{menu.country}";
	static final String MENU_COUNTRY_POPOVER = "#{menu.country.popover}";
	static final String MENU_PLACE = "#{menu.place}";
	static final String MENU_PLACE_POPOVER = "#{menu.place.popover}";
	static final String MODULE_ADMINISTRATIVE = "#{module.administrative}";
	static final String MODULE_REP_DESC = "#{module.rep.desc}";
	static final String MSG_MAPQUEST_KEY_REQUIRED = "#{msg.mapquest.key.required}";
	static final String TEXT_ADDRESS_CODE = "#{text.address.code}";
	static final String TEXT_MAP_SETTING = "#{text.map.setting}";
	static final String TEXT_MAPVIEW_PRESS_ENTER = "#{text.mapview.press.enter}";
	static final String VIEW_ADDRESS = "#{view.address}";
	static final String VIEW_ADMIN_AREA = "#{view.admin.area}";
	static final String VIEW_ADMIN_AREA_IMP = "#{view.admin.area.imp}";
	static final String VIEW_CITY = "#{view.city}";
	static final String VIEW_CITY_IMP = "#{view.city.imp}";
	static final String VIEW_COUNTRY = "#{view.country}";
	static final String VIEW_COUNTRY_IMP = "#{view.country.imp}";
	static final String VIEW_MAP_SETTING = "#{view.map.setting}";
	static final String VIEW_PLACE = "#{view.place}";
	static final String VIEW_PLACE_STREET_TYPE = "#{view.place.street.type}";
	static final String VIEW_PLACE_TYPE = "#{view.place.type}";
	static final String VIEW_REPO_PLACE = "#{view.repo.place}";
	static final String VIEW_STREET_TYPE = "#{view.street.type}";
}
