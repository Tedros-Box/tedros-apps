...
public class LocationUtils {
	...
	public static void filterCity(Annotation ann, Country country, AdminArea adminArea, ObservableList<City> items ) {
		Platform.runLater(()->{
	...
	public static void filterAdminArea(Annotation ann, Country country, final ObservableList<AdminArea> items) {
		Platform.runLater(()->{
