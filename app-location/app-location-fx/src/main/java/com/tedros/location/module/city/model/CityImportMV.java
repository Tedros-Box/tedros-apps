 ...
 *
 */
@TEjbService(serviceName = "ICityImportControllerRemote", model=CityImport.class)
@TPresenter(decorator = @TDecorator(type=TImportFileModalDecorator.class, viewTitle="#{view.city.imp}"),
