...
public class RedmineApiGateway {
	...
	public void loadCustomFieldMetadata() {
	    try {
	        ...
	        throw new TBusinessException("Erro ao carregar metadados de campos personalizados: " + e.getMessage());
	    }
	}
	...
	public ResultsWrapper<Issue> getIssuesByFilters(Map<String, FilterCondition> filters) {
	    try {
	        ...
	        throw new TBusinessException("Erro ao buscar issues: " + e.getMessage());
	    }
	}
